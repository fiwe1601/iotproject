...
public class MqttClientMessageReceiverHandler<Message> extends ClientMessageReceiverHandler<MqttClientMessageReceiverHandler<Message>, Message>{
    Socket clientSocket; // Client Socket

    public MqttClientMessageReceiverHandler(MessageParser<Message> messageParser) {
        super(messageParser);
    }
