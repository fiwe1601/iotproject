...
public abstract class ClientMessageReceiverHandler<T, Message> extends Thread{
    ...
    protected ClientMessageReceiverHandler(MessageParser<Message> messageParser) {
    ...
    public ClientMessageReceiverHandler<T, Message> setClientConnectListener1(ClientConnectMessageListener<Message> clientConnectListener) {
        this.clientConnectListener = clientConnectListener;
        return this;
    }

    public ClientMessageReceiverHandler<T, Message> setPacketLength1(int packetSize) {
        this.packetSize = packetSize;
        return this;
    }

    public ClientMessageReceiverHandler<T, Message> setPort1(int port) {
        this.port = port;
        return this;
    }
}
